 ...
 * @param carttype
 */
function ygAddToCart(commodity_code,code,carttype){
	...
	goods.quick    = quick;
	goods.yg_co_code = commodity_code;
	goods.code = code;
	goods.number   = number;
	goods.carttype = (typeof(carttype) == "undefined") ? 0 : parseInt(carttype);

	jQuery.post(web_url+"/mobile/flow.php",{step:"yg_add_to_cart", goods:JSON.stringify(goods), t:Math.random()}, function(data){
