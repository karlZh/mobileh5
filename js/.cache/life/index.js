/*TMODJS:{"version":62,"md5":"e3e446efb85a5236eb397e070131ad3a"}*/
template('life/index',function($data,$filename
/**/) {
...
$each(data.goods,function(cate,$index){
$out+=' <a class="mui-control-item cake_pinpai_item href_click" data-href="../cate/list.html?code=';
$out+=$escape(cate.code);
...
$out+='</span></h4> <a data-href="../cate/list.html?code=';
$out+=$escape(attr.code);
...
$out+=' <div class="mui-col-xs-6 floor_listBox"> <a data-href="../cate/details.html?commodityCode=';
$out+=$escape(good.commodityCode);
$out+='" class="href_click"> <div class="mui-pull-left floor_listLeft"> <div class="floor_list_name mui-ellipsis-2">';
$out+=$escape(good.commodityCname);
