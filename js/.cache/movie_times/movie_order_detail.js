/*TMODJS:{"version":18,"md5":"a4406c0317699d41a7cd4ec91ecd850b"}*/
...
$out+=' <ul class="mui-table-view margin_top_15"> <li class="mui-table-view-cell"><h4 class="mui-pull-left" id="source">聚优卡号</h4><p class="mui-pull-right">';
...
$out+=' <script> /*根据判断华影还是聚优从而改变相应的显示*/ if(localStorage.source=="true"){ $("#source").text("华影卡号") } </script>';
