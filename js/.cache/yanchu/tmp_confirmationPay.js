/*TMODJS:{"version":78,"md5":"cc3ccebc1c57928a874abca2075fdb3b"}*/
template('yanchu/tmp_confirmationPay',function($data,$filename
/**/) {
...
$out+=$escape(order_amount);
$out+='" /> </div> </li> </ul> </div> <script> /*根据判断华影还是聚优从而改变相应的显示*/ if(localStorage.source=="true"){ $("#source").text("华影卡号") } </script>';
