/*TMODJS:{"version":69,"md5":"b92be30b1cc2fc1d8b6ab3b34341d852"}*/
template('yanchu/tmp_yanchu_submit',function($data,$filename
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,order=$data.order,shipping=$data.shipping,item=$data.item,shipping_info=$data.shipping_info,$out='';$out+='<nav class="mui-bar mui-bar-tab mui-row"> <div class="mui-col-xs-7"><a class="mui-tab-item">订单总额：<span class="color_2fd0b5">';
...
$out+='</span>点 </div> </div> </div> <ul class="mui-table-view margin_top_15"> <li class="mui-table-view-cell"> 支付方式<span class="mui-pull-right color_8f8f94" id="source">聚优卡支付</span> </li> <li class="mui-table-view-cell"> 配送方式<span class="mui-pull-right color_8f8f94">供货商物流</span> </li> <li class="mui-table-view-cell"> 运费合计<span class="mui-pull-right color_8f8f94">';
$out+=$escape(shipping_info.shipping_fee);
$out+='</span> </li> </ul> </div> <script> /*根据判断华影还是聚优从而改变相应的显示*/ if(localStorage.source=="true"){ $("#source").text("华影卡支付") } </script>';
