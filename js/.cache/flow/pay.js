/*TMODJS:{"version":95,"md5":"6f48cfb053199bc036f8f54c9ec71e5f"}*/
...
$out+=$escape(data.order.order_amount);
$out+='</span>点，请尽快付款</h4> </div> <ul class="mui-table-view confirm_list"> <li class="mui-table-view-cell"> <h4 class="mui-pull-left" id="source">聚优卡号</h4> <p class="mui-pull-right">';
