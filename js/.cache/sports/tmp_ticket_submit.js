/*TMODJS:{"version":53,"md5":"84772a8e2c07ee90e21ab71566183888"}*/
...
$out+='点</p> </div> </div> <div class="mui-input-group margin_top_15"> <div class="mui-input-row"> <h4 class="mui-pull-left" id="source">聚优卡号</h4> <p class="mui-pull-right">';
$out+=$escape(user_name);
$out+='</p> </div> <div class="mui-input-row"> <label>密码</label> <input type="password" name="password" placeholder="请输入卡密码"> </div> </div> <input type="hidden" name="order_amount"/> <div class="color_2fd0b5 ticket_submit_tips">温馨提示:需提前1天预订，要求必须1440分钟内完成在线支付</div> </div> <script> /*根据判断华影还是聚优从而改变相应的显示*/ if(localStorage.source=="true"){ $("#source").text("华影卡号") } </script>';
